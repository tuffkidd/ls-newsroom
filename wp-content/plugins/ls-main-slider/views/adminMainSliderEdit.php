<div class="wrap">
	...
	<form novalidate="novalidate" action="" method="post" id="mainSliderEditFrm">
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th>타입선택</th>
					<td>
						<label><input type="radio" name="type" value="P" <?php if ($slide->type == 'P') { ?>checked<?php } ?>> 포스트</label>,
						<label><input type="radio" name="type" value="L" <?php if ($slide->type == 'L') { ?>checked<?php } ?>> 외부링크</label>
					</td>
				</tr>
				<tr>
					<th>포스트 URL</th>
					<td>
						<input type="text" name="post_url" id="post_url" value="<?php echo get_permalink($slide->post_id); ?>" size="100">
					</td>
				</tr>
				<tr>
					<th>이미지</th>
					<td>
						<input type="text" name="thumb" id="thumb" class="media-url" value="<?php echo $slide->thumb; ?>" size="100">
				...
				<tr>
					<th>타이틀</th>
					<td>
						<input type="text" name="title" id="title" value="<?php echo $slide->title; ?>" size="100">
					</td>
				</tr>
				<tr>
					<th>링크 URL</th>
					<td>
						<input type="text" name="url" id="url" value="<?php echo $slide->url; ?>" size="100">
					</td>
				</tr>
			</tbody>
			</tbody>
		...
		<p class="submit">
			<input type="submit" value="수정완료" class="button button-primary" id="submit" name="submit">
